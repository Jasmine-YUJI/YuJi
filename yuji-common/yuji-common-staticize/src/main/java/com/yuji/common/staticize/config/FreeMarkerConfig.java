package com.yuji.common.staticize.config;
...
import com.yuji.common.staticize.config.properties.FreeMarkerProperties;
...
public class FreeMarkerConfig {
	...
	FileTemplateLoader defaultFileTemplateLoader(FreeMarkerProperties properties) throws IOException {
		...
		templateLoaderPath = FileTypeUtils.normalizePath(templateLoaderPath);
		if (!templateLoaderPath.endsWith("/")) {
			templateLoaderPath += "/";
		}
		FileTypeUtils.mkdirs(templateLoaderPath);
