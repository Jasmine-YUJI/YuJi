...
<script>
import CMSCatalogTree from '@/views/cms/catalog/catalogTree';
import CMSCatalogInfo from '@/views/cms/catalog/catalogInfo';
import CMSCatalogExtend from '@/views/cms/catalog/catalogExtend';
