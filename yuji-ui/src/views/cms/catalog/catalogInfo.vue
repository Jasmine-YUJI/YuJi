...
<script>
import * as catalogApi from "@/api/cms/contentcore/catalog";
import CMSCatalogSelector from "@/views/cms/catalog/catalogSelector";
import CMSContentSelector from "@/views/cms/content/contentSelector";
import CMSTemplateSelector from '@/views/cms/template/templateSelector';
