...
<script>
import { getCatalogExtends, saveCatalogExtends, applyConfigPropsToChildren } from "@/api/cms/contentcore/catalog";
import { getHotWordGroupOptions } from "@/api/cms/contentcore/word";
import { listXModelOptions } from "@/api/cms/contentcore/exmodel";
import CMSCatalogSelector from "@/views/cms/catalog/catalogSelector";
