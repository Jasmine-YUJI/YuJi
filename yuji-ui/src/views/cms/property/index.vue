<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['cms:property:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['cms:property:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="propertyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="属性编码" align="center" prop="propCode" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="属性编码" prop="propCode">
          <el-input v-model="form.propCode" placeholder="请输入属性编码" />
        </el-form-item>
        <el-form-item label="属性值" prop="propValue">
          <el-input v-model="form.propValue" placeholder="请输入属性值" />
        </el-form-item>
...
<script>
import { listProperty, getProperty, delProperty, addProperty, updateProperty } from "@/api/cms/property";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除站点自定义属性编号为"' + propertyIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('cms/property/export', {
        ...this.queryParams
